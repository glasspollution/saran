  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 relative overflow-hidden bg-white">
        ...
        {/* Gradient overlay to fade into white on the right */}
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-white pointer-events-none" />
      </div>

      {/* Right side - Auth Form */}
      <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl bg-white flex items-center justify-center p-6 md:p-10 relative z-10">
